module github.com/ahmos0/goLambdaFirst.git
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.10.4 // indirect
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.4.30 // indirect
